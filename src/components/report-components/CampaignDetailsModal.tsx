...
export function CampaignDetailsModal({ campaign, onClose }: CampaignDetailsModalProps) {
  ...
  const successRate = useMemo(() => {
    ...
    return Math.min(100, Number(((sent / total) * 100).toFixed(1)));
  }, [campaign?.totalContacts, campaign?.sentMessages]);

  type MaybeCancelled = { cancelledAt?: string | Date | null };
  const cancelledAt = (campaign as MaybeCancelled | null)?.cancelledAt ?? null;
        ...
        <DialogContent className="max-w-4xl p-0 overflow-hidden">
          ...
          <div className="px-6 py-6 bg-gradient-to-br from-background to-muted/40">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <Card className="border shadow-md hover:shadow-lg transition py-0 min-h-[140px]">
                ...
                <CardContent className="pt-2 text-3xl font-extrabold bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">
              ...
              <Card className="border shadow-md hover:shadow-lg transition py-0 min-h-[140px]">
                ...
                <CardContent className="pt-2 text-3xl font-extrabold bg-gradient-to-r from-green-600 to-green-400 bg-clip-text text-transparent">
              ...
              <Card className="border shadow-md hover:shadow-lg transition py-0 min-h-[140px]">
                ...
                <CardContent className="pt-2 text-3xl font-extrabold bg-gradient-to-r from-red-600 to-red-400 bg-clip-text text-transparent">
