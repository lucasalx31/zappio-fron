  ...
  <div className="flex items-start justify-between gap-4">
    ...
    <Button asChild variant="outline" size="sm" className="text-xs flex-shrink-0">
      ...
      <CardContent className="flex-1 flex flex-col justify-between">
        <div>
          <div className="mb-5 p-3 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg">
            <p className="text-xs text-blue-700 dark:text-blue-300">
              <strong>Dica:</strong> Baixe o modelo para ver o formato correto dos números
            </p>
          </div>
          <div className="flex flex-col justify-center h-[170px] border-2 border-dashed border-muted-foreground/25 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
        ...
        <div className="mb-5 h-20 flex items-center">
          {file && (
            <div className="w-full bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg p-2">
